...
git allows developers to see entire timeline of their changes or progression of a any projects all in one place, the difference between git and github is that github hosts git repositories, meaning it allows for easier collaboration directly into the development process.
2. Why do we create a branch? 
we create a branch to write your own code without changing the original code basically branch out of the original repository and either add to the project or create your own from an existing source.
3. What is the purpose of a pull request? 
a pull request allows other people to see what you've been working on letting you collaborate with others before implementing it into the base branch.
4. What is the command you can use to switch between branches? For example you are working on a feature branch and you want to switch back to main. 
you would use git checkout branch in this instance you would do git checkout main
5. Explain the difference between `git fetch`, `git merge` and `git pull` what does each command do? 
git fetch allows you to download objects from another repository, git merge allows you to integrate with another repository or branch, and git pull does both of these actions
6. What is a merge conflict? How do you resolve a merge conflict? 
this happens when you merge branches that have competing commits, you resolve this by manually editing the conflicted file and selecting the changes you want to keep in the final merge